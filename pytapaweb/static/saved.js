...
var today = $('#solution').text();
var newToday = today.split(";");

var size = newToday.length;

var finaleToday = []
var finaleSplit = []

for (let i = 0; i < size; i++) {
    finaleSplit.push(newToday[i].split(","))
};

for (let x = 0; x < size; x++) {
    let arr = [];
    for (var y = 0; y < size; y++) {
        arr.push(parseInt(finaleSplit[x][y])); 
    };
...
function startButton(buttonid) {
    $(buttonid).click(function () {
        tapa(finaleToday, 'daily', '#dailybutton');
